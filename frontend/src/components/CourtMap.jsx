...
const CourtMap = ({ onNavigate }) => {
    ...
    return (
            ...
            <main className="max-w-[1100px] mx-auto px-6 py-6">
                <div className="court-map">
                    ...
                    <div className="south-grid">
                        {/* Street labels row */}
                        <div className="south-header">
                            <VLabel>SCOTCH STREET</VLabel>
                            <div className="sh-cols"><span>W</span><span>E</span></div>
        ...
        .south-header {
          display: none; /* street names embedded in vertical labels below */
        }
        .south-row {
          display: grid;
          grid-template-columns: 1fr 1fr 8px 1fr 1fr 8px 1fr;
          gap: 0;
        }
        .row-gap {
