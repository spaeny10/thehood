...
- **Lake Historical Trends** — Collapsible charts for elevation, water temp, and outflow over 24h/3d/7d/30d
- **KDWP Fishing Report** — Official Kanopolis Reservoir fishing report scraped from ksoutdoors.gov (species, rating, size, baits/methods/location), cached 24h, collapsible card
...
│       ├── services/              # Data collection + KDWP scraper
